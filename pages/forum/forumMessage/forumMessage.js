...
Page({
  ...
  sendReplay: function () {
    ...
    var from_id = student.studentnum;
    var from_name = student.name;
    var from_face = student.face;
    var from_role = 7;
    let title = "";
    ...
    app.postRequest('/question/questionReply', data, function (res) {
      console.log(res)
      ...
      if (status == 1) {
        ...
        app.showErrorModal(msg, "回复过程中出错了")
      }
    })
  },
  //第一次加载的时候请求的数据
