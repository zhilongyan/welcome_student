...
Page({
  ...
  onLoad: function (options) {
    let bedbh = options.bedbh;
    var dormbh = wx.getStorageSync("dorm");
    student = wx.getStorageSync("student_Info");
    if (dormbh) {
      let dorm = dormbh + "-" + bedbh
      this.setData({ dormbh: dorm, name: student.name, majorname: student.majorname, classbh: student.class, studentNum: student.studentnum })
    }
